...
class MusicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create music" do
    assert_difference("Music.count") do
      post musics_url, params: { music: { artist: @music.artist, cover_image: @music.cover_image, genre: @music.genre, title: @music.title } }
    end
  ...
  test "should update music" do
    patch music_url(@music), params: { music: { artist: @music.artist, cover_image: @music.cover_image, genre: @music.genre, title: @music.title } }
